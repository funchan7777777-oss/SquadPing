...
class RegisterPassageStage extends StatelessWidget {
  const RegisterPassageStage({
    super.key,
    required this.onSigninPulled,
    required this.onNextStepPulled,
  });

  final VoidCallback onSigninPulled;
  final VoidCallback onNextStepPulled;
      ...
      foreground: Stack(
        ...
        children: [
          ...
          const GateCopyCluster(
            heading: 'Register',
            primaryLine: 'Create information',
            secondaryLine: 'Create your profile',
            topOffset: 150,
          ),
          Positioned(
            left: 30,
          ...
          Positioned(
            ...
            child: Column(
              children: [
                ...
                PngSignalButton(
                  assetPath: SquadPingAssets.nextStepButton,
                  semanticLabel: 'Next step',
                  onPressed: onNextStepPulled,
                  widthFactor: 0.68,
                  maxWidth: 260,
                ),
              ],
